pkg_name=drupal-nginx
pkg_origin=baggerspion
pkg_version=1.11.10
pkg_description="NGINX web server servinf Drupal."
...
pkg_deps=(core/glibc core/libedit core/ncurses core/zlib core/bzip2 core/openssl core/pcre core/drush)
